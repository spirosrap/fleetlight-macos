...
- Authenticated Android **Check for updates** requests that asynchronously force fresh installed-version probes, npm and official Mac app release lookups, and Linux package checks without installing, updating, or restarting anything
